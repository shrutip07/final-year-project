...
//   }
//   // existing validation + inserts here...
// }


//       // basic required-field validation
//       if (!unit_id || !full_name || !dob || !gender || !academic_year || !standard) {
//         // skip invalid row
//         continue;
//       }
...
//     console.error(err);
//     res.status(500).json({ message: 'Error importing students', error: err.message });
//   } finally {
...
exports.importStudents = async (req, res) => {
  ...
  try {
    ...
    // DEBUG LOGS – to see what Excel actually produced
    console.log("First row raw from Excel:", rows[0]);
