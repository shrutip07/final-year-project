...
router.use('/fire-safety', require('./fireSafetyRoutes')); // after requiring it
...
router.get('/physical-safety', authenticateToken, authorizeRoles('clerk'), clerkController.getPhysicalSafetyInfo);
router.put('/physical-safety', authenticateToken, authorizeRoles('clerk'), clerkController.updatePhysicalSafetyInfo);
// Physical safety analytics
router.get('/physical-safety/analytics', authenticateToken, authorizeRoles('clerk'), clerkController.getPhysicalSafetyAnalytics);
