...
//   // Fetch filled forms once
//   useEffect(() => {
//     const fetchFilledForms = async () => {
//       try {
//         const token = localStorage.getItem('token');
//         const res = await axios.get('http://localhost:5000/api/admin/filled-forms-detailed', {
...
//   // Filtering for filledForms based on selected unit (optional, can comment/remove)
//   const filteredForms = selectedUnit
//     ? filledForms.filter(f => f.unit_id === Number(selectedUnit) || f.unit_id === selectedUnit)
//     : filledForms;
...
//           {/* New: Filled Forms Table */}
//           <div className="card mt-4">
//             <div className="card-header bg-info text-white">
//               <h4 className="mb-0">Filled Forms Data</h4>
//             </div>
...
//                   <thead>
//                     <tr>
//                       {Object.keys(filteredForms[0]).map(col => (
//                         <th key={col}>{col}</th>
//                       ))}
//                     </tr>
//                   </thead>
...
//                 </table>
//               ) : (
//                 <div>No filled form responses found.</div>
//               )}
//             </div>
//           </div>
//         </>
