...
// // //     "student_id", "full_name", "standard", "division", "roll_number", "academic_year", "passed", "dob", "gender",
// // //     "address", "parent_name", "parent_phone", "admission_date", "createdat", "updatedat"
// // //   ]);
// // //   const [teachersShowColDropdown, setTeachersShowColDropdown] = useState(false);
// // //   const [studentsShowColDropdown, setStudentsShowColDropdown] = useState(false);
// // //   const [studentsYear, setStudentsYear] = useState("");
...
// // //           axios.get("http://localhost:5000/api/admin/units", { headers: { Authorization: `Bearer ${token}` } }),
// // //           axios.get("http://localhost:5000/api/report/years", { headers: { Authorization: `Bearer ${token}` } })
// // //         ]);
...
// // //       const link = document.createElement("a");
// // //       link.href = url;
// // //       link.download = `School_Report_Unit_${unitId}${selectedYear ? `_${selectedYear}` : ""}.pdf`;
// // //       link.click();
// // //     } catch (err) {
// // //       alert("Failed to download report");
// // //     }
...
// // //       <select className="form-select mb-3" value={selectedYear} onChange={e => setSelectedYear(e.target.value)}>
// // //         <option value="">All Years</option>
// // //         {years.map((y, i) => (
// // //           <option key={i} value={y}>{y}</option>
// // //         ))}
// // //       </select>
// // //       <p>Select a school to download the full report</p>
// // //       <div className="row">
// // //         {safeUnits.map((unit) => (
// // //           <div key={unit.unit_id} className="col-md-4 col-lg-3 col-sm-6 mb-3">
// // //             <div className="card p-3 shadow-sm" style={{ borderRadius: 12 }}>
...
// // //                 Staff: {unit.staff_count} | Students: {unit.student_count}
// // //               </p>
// // //               <button className="btn btn-primary" onClick={() => downloadReport(unit.unit_id)}>
// // //                 Download Report
// // //               </button>
// // //             </div>
// // //           </div>
...
// // //         <form onSubmit={addNotification}>
// // //           <label className="form-label" style={{ fontWeight: 500 }}>Send To:</label>
// // //           <select className="form-select mb-2" value={notifRole} onChange={e => setNotifRole(e.target.value)}>
// // //             <option value="principal">Principal</option>
// // //             <option value="teacher">Teacher</option>
// // //           </select>
// // //           <label className="form-label">Title:</label>
// // //           <input type="text" className="form-control mb-2" value={notifTitle} onChange={e => setNotifTitle(e.target.value)} required />
// // //           <label className="form-label">Message:</label>
// // //           <textarea className="form-control mb-2" value={notifMsg} onChange={e => setNotifMsg(e.target.value)} required />
// // //           <button className="btn btn-primary w-100" disabled={notifLoading} type="submit">
// // //             Send&nbsp;{notifLoading ? <span className="spinner-border spinner-border-sm"></span> : <span>&#x2705;</span>}
// // //           </button>
// // //         </form>
...
// // //         <form onSubmit={addForm}>
// // //           <label className="form-label" style={{ fontWeight: 500 }}>Send To:</label>
// // //           <select className="form-select mb-2" value={formRole} onChange={e => setFormRole(e.target.value)}>
// // //             <option value="principal">Principal</option>
// // //             <option value="teacher">Teacher</option>
// // //           </select>
// // //           <label className="form-label">Form Title:</label>
// // //           <input type="text" className="form-control mb-2" value={formTitle} onChange={e => setFormTitle(e.target.value)} required />
// // //           <label className="form-label">Description (optional):</label>
// // //           <textarea className="form-control mb-2" value={formDesc} onChange={e => setFormDesc(e.target.value)} />
// // //           <label className="form-label">Deadline:</label>
// // //           <input type="datetime-local" className="form-control mb-2" value={formDeadline} onChange={e => setFormDeadline(e.target.value)} />
// // //           <label className="form-label">Questions:</label>
// // //           {formQuestions.map((q, idx) => (
// // //             <div key={idx} style={{ marginBottom: 10, background: "#f8f8fb", borderRadius: 4, padding: 10 }}>
// // //               <input placeholder="Question text" className="form-control mb-1" value={q.question_text} required onChange={e => handleQuestionChange(idx, "question_text", e.target.value)} />
// // //               <select className="form-select mb-1" value={q.question_type} onChange={e => handleQuestionChange(idx, "question_type", e.target.value)}>
// // //                 <option value="text">Text</option>
// // //                 <option value="mcq">MCQ</option>
// // //               </select>
// // //               {q.question_type === "mcq" && (
// // //                 <input placeholder="Comma separated options" className="form-control mb-1" value={q.options} onChange={e => handleQuestionChange(idx, "options", e.target.value)} />
// // //               )}
// // //               <button type="button" className="btn btn-danger btn-sm" onClick={() => removeFormQuestion(idx)} disabled={formQuestions.length === 1}>Remove</button>
// // //             </div>
// // //           ))}
// // //           <button type="button" className="btn btn-secondary mb-2" onClick={addFormQuestion}>Add Question</button>
// // //           <button className="btn btn-success w-100" disabled={formLoading} type="submit">
// // //             Create Form &amp; Send Notification&nbsp;{formLoading ? <span className="spinner-border spinner-border-sm"></span> : <span>&#x2705;</span>}
// // //           </button>
// // //         </form>
